...
import { VideoOff, Zap, DollarSign, Share2, TrendingUp, Smartphone, EyeOff } from 'lucide-react';
...
export default function BenefitsSection() {
  return (
    <section id="vantagens" className="py-16 md:py-24 bg-card scroll-mt-20">
      <div className="container mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {benefits.map((benefit, index) => (
            <Card key={index} className="bg-background border-border hover:border-primary/50 transition-all duration-300 group shadow-lg hover:shadow-primary/20">
