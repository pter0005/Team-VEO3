    ...
    <section id="vantagens" className="py-16 md:py-24 bg-card/50 scroll-mt-20">
      <div className="container mx-auto max-w-7xl px-4 md:px-6">
        <h2 className="font-headline text-3xl md:text-4xl font-bold text-center mb-12">
          Por que vídeos com <span className="text-primary">Team VEO3</span> são a nova onda do digital?
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {benefits.map((benefit, index) => (
            <Card key={index} className="bg-background-end border border-primary/30 hover:border-primary/70 hover:shadow-primary-glow-soft transition-all duration-300 group shadow-lg hover:scale-105 ease-in-out">
