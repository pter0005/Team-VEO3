    ...
    <section className="py-16 md:py-24 bg-card">
      <div className="container mx-auto max-w-7xl px-4 md:px-6">
        <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground mt-2 md:text-lg">Ao se inscrever hoje, você leva tudo isso DE GRAÇA!</p>
        </div>
          ...
          {bonuses.map((bonus, index) => (
            <Card key={index} className="bg-background border-border shadow-lg flex flex-col">
              ...
              <CardContent className="flex-grow">
                <p className="text-sm text-muted-foreground text-center">{bonus.description}</p>
              </CardContent>
            </Card>
          ))}
        </div>
